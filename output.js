//Mon Jul 22 2024 04:32:07 GMT+0000 (Coordinated Universal Time)
...
async function _0x589c6d(_0x501293) {
  ...
  let _0x23af9e = await _0x768dee("mtop.miniapp.cloud.invoke.top", _0x501293, _0x3e5aa4);
  ...
  for (let _0x5a94ed = 0; _0x5a94ed < _0x4399a0.length; _0x5a94ed++) {
    ...
    for (let _0x103451 = 0; _0x103451 < _0xa8f67f.length; _0x103451++) {
      ...
      if (!_0x336da4.cropQueryId) {
        ...
        _0x3f3134.type = 2;
        _0x3f3134.pos1 = _0x104134.pos;
        _0x3f3134.pos2 = _0x336da4.pos;
        _0x3f3134.timestamp = new Date().getTime();
